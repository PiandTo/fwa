...
public class User {
	...
	public boolean equals(Object o) {
		...
		User user = (User) o;
		return id.equals(user.id) && firstName.equals(user.firstName) && lastName.equals(user.lastName) && phoneNumber.equals(user.phoneNumber) && password.equals(user.password);
	}
